...
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
pub const ENUM_MAX_RPC_REQUEST: u8 = 10;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_RPC_REQUEST: [RpcRequest; 11] = [
  RpcRequest::NONE,
  ...
  RpcRequest::SendRawTransactionRequest,
];
...
impl RpcRequest {
  ...
  pub const SendRawTransactionRequest: Self = Self(10);
  ...
  pub const ENUM_VALUES: &'static [Self] = &[
    ...
    Self::SendRawTransactionRequest,
  ];
  ...
  pub fn variant_name(self) -> Option<&'static str> {
    match self {
      ...
      Self::ValidateMinedBlockProposalRequest => Some("ValidateMinedBlockProposalRequest"),
      Self::GetMiningStatusRequest => Some("GetMiningStatusRequest"),
      Self::SendRawTransactionRequest => Some("SendRawTransactionRequest"),
      _ => None,
    }
  }
}
...
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
pub const ENUM_MIN_SEND_RAW_TRANSACTION_RESULT: i32 = 0;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
pub const ENUM_MAX_SEND_RAW_TRANSACTION_RESULT: i32 = 5;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_SEND_RAW_TRANSACTION_RESULT: [SendRawTransactionResult; 6] = [
  SendRawTransactionResult::ACCEPTED,
  SendRawTransactionResult::ALREADY_IN_CHAIN,
  SendRawTransactionResult::MEMPOOL_REJECTED,
  SendRawTransactionResult::MEMPOOL_ERROR,
  SendRawTransactionResult::MAX_FEE_EXCEEDED,
  SendRawTransactionResult::DESERIALIZATION_ERROR,
];

#[derive(Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash, Default)]
#[repr(transparent)]
pub struct SendRawTransactionResult(pub i32);
#[allow(non_upper_case_globals)]
impl SendRawTransactionResult {
  pub const ACCEPTED: Self = Self(0);
  pub const ALREADY_IN_CHAIN: Self = Self(1);
  pub const MEMPOOL_REJECTED: Self = Self(2);
  pub const MEMPOOL_ERROR: Self = Self(3);
  pub const MAX_FEE_EXCEEDED: Self = Self(4);
  pub const DESERIALIZATION_ERROR: Self = Self(5);

  pub const ENUM_MIN: i32 = 0;
  pub const ENUM_MAX: i32 = 5;
  pub const ENUM_VALUES: &'static [Self] = &[
    Self::ACCEPTED,
    Self::ALREADY_IN_CHAIN,
    Self::MEMPOOL_REJECTED,
    Self::MEMPOOL_ERROR,
    Self::MAX_FEE_EXCEEDED,
    Self::DESERIALIZATION_ERROR,
  ];
  /// Returns the variant's name or "" if unknown.
  pub fn variant_name(self) -> Option<&'static str> {
    match self {
      Self::ACCEPTED => Some("ACCEPTED"),
      Self::ALREADY_IN_CHAIN => Some("ALREADY_IN_CHAIN"),
      Self::MEMPOOL_REJECTED => Some("MEMPOOL_REJECTED"),
      Self::MEMPOOL_ERROR => Some("MEMPOOL_ERROR"),
      Self::MAX_FEE_EXCEEDED => Some("MAX_FEE_EXCEEDED"),
      Self::DESERIALIZATION_ERROR => Some("DESERIALIZATION_ERROR"),
      _ => None,
    }
  }
}
impl ::core::fmt::Debug for SendRawTransactionResult {
  fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
    if let Some(name) = self.variant_name() {
      f.write_str(name)
    } else {
...
impl<'a> ::flatbuffers::Follow<'a> for SendRawTransactionResult {
  type Inner = Self;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    let b = unsafe { ::flatbuffers::read_scalar_at::<i32>(buf, loc) };
...
impl ::flatbuffers::Push for SendRawTransactionResult {
    type Output = SendRawTransactionResult;
    #[inline]
    unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
        unsafe { ::flatbuffers::emplace_scalar::<i32>(dst, self.0) };
    }
...
impl ::flatbuffers::EndianScalar for SendRawTransactionResult {
  type Scalar = i32;
  #[inline]
  fn to_little_endian(self) -> i32 {
    self.0.to_le()
...
impl<'a> ::flatbuffers::Verifiable for SendRawTransactionResult {
  #[inline]
  fn run_verifier(
    v: &mut ::flatbuffers::Verifier, pos: usize
  ) -> Result<(), ::flatbuffers::InvalidFlatbuffer> {
...
impl ::flatbuffers::SimpleToVerifyInSlice for SendRawTransactionResult {}
...
impl<'a> RpcResult<'a> {
  ...
  pub fn is_success(&self) -> bool {
    ...
    unsafe { self._tab.get::<bool>(RpcResult::VT_IS_SUCCESS, Some(false)).unwrap()}
  }
  #[inline]
  pub fn error_code(&self) -> i32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(RpcResult::VT_ERROR_CODE, Some(0)).unwrap()}
  }
  #[inline]
  pub fn error_msg(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(RpcResult::VT_ERROR_MSG, None)}
  }
  #[inline]
  pub fn data(&self) -> Option<::flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, u8>>>(RpcResult::VT_DATA, None)}
  }
}
...
impl<'a> RpcCall<'a> {
  ...
  pub fn rpc_type(&self) -> RpcRequest {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<RpcRequest>(RpcCall::VT_RPC_TYPE, Some(RpcRequest::NONE)).unwrap()}
  }
  #[inline]
  pub fn rpc(&self) -> Option<::flatbuffers::Table<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Table<'a>>>(RpcCall::VT_RPC, None)}
  }
  #[inline]
  ...
  #[inline]
  #[allow(non_snake_case)]
  pub fn rpc_as_validate_mined_block_proposal_request(&self) -> Option<ValidateMinedBlockProposalRequest<'a>> {
  ...
  #[inline]
  #[allow(non_snake_case)]
  pub fn rpc_as_send_raw_transaction_request(&self) -> Option<SendRawTransactionRequest<'a>> {
    if self.rpc_type() == RpcRequest::SendRawTransactionRequest {
      self.rpc().map(|t| {
       // Safety:
       // Created from a valid Table for this object
       // Which contains a valid union in this slot
       unsafe { SendRawTransactionRequest::init_from_table(t) }
     })
    } else {
      None
    }
    ...
    v.visit_table(pos)?
     .visit_union::<RpcRequest, _>("rpc_type", Self::VT_RPC_TYPE, "rpc", Self::VT_RPC, false, |key, v, pos| {
        match key {
          ...
          RpcRequest::SendRawTransactionRequest => v.verify_union_variant::<::flatbuffers::ForwardsUOffset<SendRawTransactionRequest>>("RpcRequest::SendRawTransactionRequest", pos),
          _ => Ok(()),
        }
     })?
     .finish();
  ...
  fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
    let mut ds = f.debug_struct("RpcCall");
      ...
      match self.rpc_type() {
        ...
        RpcRequest::SendRawTransactionRequest => {
          if let Some(x) = self.rpc_as_send_raw_transaction_request() {
            ds.field("rpc", &x)
          } else {
            ds.field("rpc", &"InvalidFlatbuffer: Union discriminant does not match value.")
          }
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> TxIdBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> TxIdBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    TxIdBuilder {
      fbb_: _fbb,
      start_: start,
...
impl<'a> Tx<'a> {
  ...
  pub fn txid(&self) -> Option<TxId<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<TxId>>(Tx::VT_TXID, None)}
  }
  #[inline]
  pub fn raw(&self) -> Option<::flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, u8>>>(Tx::VT_RAW, None)}
  }
  #[inline]
  pub fn spent_coins(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<Coin<'a>>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<Coin>>>>(Tx::VT_SPENT_COINS, None)}
  }
}
...
impl<'a> BlockTx<'a> {
  ...
  pub fn tx(&self) -> Option<Tx<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<Tx>>(BlockTx::VT_TX, None)}
  }
  #[inline]
  ...
  pub fn undo_size(&self) -> u32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u32>(BlockTx::VT_UNDO_SIZE, Some(0)).unwrap()}
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> BlockTxBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> BlockTxBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    BlockTxBuilder {
      fbb_: _fbb,
      start_: start,
...
impl<'a> MempoolTx<'a> {
  ...
  pub fn tx(&self) -> Option<Tx<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<Tx>>(MempoolTx::VT_TX, None)}
  }
  #[inline]
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> MempoolTxBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> MempoolTxBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    MempoolTxBuilder {
      fbb_: _fbb,
      start_: start,
...
impl<'a> Coin<'a> {
  ...
  pub fn tx_out(&self) -> Option<TxOut<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<TxOut>>(Coin::VT_TX_OUT, None)}
  }
  #[inline]
  pub fn is_coinbase(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(Coin::VT_IS_COINBASE, Some(false)).unwrap()}
  }
  #[inline]
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> CoinBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> CoinBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    CoinBuilder {
      fbb_: _fbb,
      start_: start,
...
impl<'a> TxOut<'a> {
  ...
  pub fn script(&self) -> Option<::flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, u8>>>(TxOut::VT_SCRIPT, None)}
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> TxOutBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> TxOutBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    TxOutBuilder {
      fbb_: _fbb,
      start_: start,
...
impl<'a> BlockHeight<'a> {
  ...
  pub fn height(&self) -> i32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(BlockHeight::VT_HEIGHT, Some(0)).unwrap()}
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> BlockHeightBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> BlockHeightBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    BlockHeightBuilder {
      fbb_: _fbb,
      start_: start,
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> BlockHashBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> BlockHashBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    BlockHashBuilder {
      fbb_: _fbb,
      start_: start,
...
impl<'a> BlockHeader<'a> {
  ...
  pub fn raw(&self) -> Option<::flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, u8>>>(BlockHeader::VT_RAW, None)}
  }
  #[inline]
  pub fn block_hash(&self) -> Option<BlockHash<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<BlockHash>>(BlockHeader::VT_BLOCK_HASH, None)}
  }
  #[inline]
  pub fn prev_block_hash(&self) -> Option<BlockHash<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<BlockHash>>(BlockHeader::VT_PREV_BLOCK_HASH, None)}
  }
  #[inline]
  pub fn n_bits(&self) -> u32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u32>(BlockHeader::VT_N_BITS, Some(0)).unwrap()}
  }
  #[inline]
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> BlockHeaderBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> BlockHeaderBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    BlockHeaderBuilder {
      fbb_: _fbb,
      start_: start,
...
impl<'a> Block<'a> {
  ...
  pub fn header(&self) -> Option<BlockHeader<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<BlockHeader>>(Block::VT_HEADER, None)}
  }
  #[inline]
  pub fn metadata(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<BlockMetadata<'a>>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<BlockMetadata>>>>(Block::VT_METADATA, None)}
  }
  #[inline]
  pub fn txs(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<BlockTx<'a>>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<BlockTx>>>>(Block::VT_TXS, None)}
  }
  #[inline]
...
impl<'a> BlockMetadata<'a> {
  ...
  pub fn field_id(&self) -> u32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u32>(BlockMetadata::VT_FIELD_ID, Some(0)).unwrap()}
  }
  #[inline]
  pub fn field_value(&self) -> Option<::flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, u8>>>(BlockMetadata::VT_FIELD_VALUE, None)}
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> BlockMetadataBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> BlockMetadataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl<'a> UpdatedBlockTip<'a> {
  ...
  pub fn block_hash(&self) -> Option<BlockHash<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<BlockHash>>(UpdatedBlockTip::VT_BLOCK_HASH, None)}
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> UpdatedBlockTipBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> UpdatedBlockTipBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl<'a> TransactionAddedToMempool<'a> {
  ...
  pub fn mempool_tx(&self) -> Option<MempoolTx<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<MempoolTx>>(TransactionAddedToMempool::VT_MEMPOOL_TX, None)}
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> TransactionAddedToMempoolBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> TransactionAddedToMempoolBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl<'a> TransactionRemovedFromMempool<'a> {
  ...
  pub fn txid(&self) -> Option<TxId<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<TxId>>(TransactionRemovedFromMempool::VT_TXID, None)}
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> TransactionRemovedFromMempoolBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> TransactionRemovedFromMempoolBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl<'a> BlockConnected<'a> {
  ...
  pub fn block(&self) -> Option<Block<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<Block>>(BlockConnected::VT_BLOCK, None)}
  }
  #[inline]
  pub fn txs_conflicted(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<TxId<'a>>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<TxId>>>>(BlockConnected::VT_TXS_CONFLICTED, None)}
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> BlockConnectedBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> BlockConnectedBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl<'a> BlockDisconnected<'a> {
  ...
  pub fn block(&self) -> Option<Block<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<Block>>(BlockDisconnected::VT_BLOCK, None)}
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> BlockDisconnectedBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> BlockDisconnectedBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl<'a> ChainStateFlushed<'a> {
  ...
  pub fn block_hash(&self) -> Option<BlockHash<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<BlockHash>>(ChainStateFlushed::VT_BLOCK_HASH, None)}
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> ChainStateFlushedBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> ChainStateFlushedBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl<'a> MiningWorkChanged<'a> {
  ...
  pub fn reason(&self) -> MiningWorkChangeReason {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<MiningWorkChangeReason>(MiningWorkChanged::VT_REASON, Some(MiningWorkChangeReason::NEW_TIP)).unwrap()}
  }
  #[inline]
  pub fn block_hash(&self) -> Option<BlockHash<'a>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<BlockHash>>(MiningWorkChanged::VT_BLOCK_HASH, None)}
  }
  #[inline]
  pub fn height(&self) -> i32 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(MiningWorkChanged::VT_HEIGHT, Some(0)).unwrap()}
  }
  #[inline]
  pub fn node_time(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(MiningWorkChanged::VT_NODE_TIME, Some(0)).unwrap()}
  }
  #[inline]
  pub fn template_epoch(&self) -> u64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u64>(MiningWorkChanged::VT_TEMPLATE_EPOCH, Some(0)).unwrap()}
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> MiningWorkChangedBuilder<'a, 'b, A> {
  ...
  pub fn add_reason(&mut self, reason: MiningWorkChangeReason) {
    self.fbb_.push_slot::<MiningWorkChangeReason>(MiningWorkChanged::VT_REASON, reason, MiningWorkChangeReason::NEW_TIP);
  }
  #[inline]
  pub fn add_block_hash(&mut self, block_hash: ::flatbuffers::WIPOffset<BlockHash<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<BlockHash>>(MiningWorkChanged::VT_BLOCK_HASH, block_hash);
  }
  #[inline]
  pub fn add_height(&mut self, height: i32) {
    self.fbb_.push_slot::<i32>(MiningWorkChanged::VT_HEIGHT, height, 0);
  }
  #[inline]
  pub fn add_node_time(&mut self, node_time: i64) {
    self.fbb_.push_slot::<i64>(MiningWorkChanged::VT_NODE_TIME, node_time, 0);
  }
  #[inline]
  pub fn add_template_epoch(&mut self, template_epoch: u64) {
    self.fbb_.push_slot::<u64>(MiningWorkChanged::VT_TEMPLATE_EPOCH, template_epoch, 0);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> MiningWorkChangedBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl<'a> GetBlockRequest<'a> {
  ...
  pub fn block_id_type(&self) -> BlockIdentifier {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<BlockIdentifier>(GetBlockRequest::VT_BLOCK_ID_TYPE, Some(BlockIdentifier::NONE)).unwrap()}
  }
  #[inline]
  pub fn block_id(&self) -> Option<::flatbuffers::Table<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Table<'a>>>(GetBlockRequest::VT_BLOCK_ID, None)}
  }
  #[inline]
  #[allow(non_snake_case)]
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> GetBlockRequestBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> GetBlockRequestBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl<'a> GetBlockResponse<'a> {
  ...
  pub fn block(&self) -> Option<Block<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<Block>>(GetBlockResponse::VT_BLOCK, None)}
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> GetBlockResponseBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> GetBlockResponseBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl<'a> GetBlockRangeRequest<'a> {
  ...
  pub fn start_height(&self) -> i32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(GetBlockRangeRequest::VT_START_HEIGHT, Some(0)).unwrap()}
  }
  #[inline]
  pub fn num_blocks(&self) -> u32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u32>(GetBlockRangeRequest::VT_NUM_BLOCKS, Some(0)).unwrap()}
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> GetBlockRangeRequestBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> GetBlockRangeRequestBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl<'a> GetBlockRangeResponse<'a> {
  ...
  pub fn blocks(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<Block<'a>>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<Block>>>>(GetBlockRangeResponse::VT_BLOCKS, None)}
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> GetBlockRangeResponseBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> GetBlockRangeResponseBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl<'a> GetBlockSliceRequest<'a> {
  ...
  pub fn file_num(&self) -> u32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u32>(GetBlockSliceRequest::VT_FILE_NUM, Some(0)).unwrap()}
  }
  #[inline]
  pub fn data_pos(&self) -> u32 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u32>(GetBlockSliceRequest::VT_DATA_POS, Some(0)).unwrap()}
  }
  #[inline]
  pub fn num_bytes(&self) -> u32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u32>(GetBlockSliceRequest::VT_NUM_BYTES, Some(0)).unwrap()}
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> GetBlockSliceRequestBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> GetBlockSliceRequestBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl<'a> GetBlockSliceResponse<'a> {
  ...
  pub fn data(&self) -> Option<::flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, u8>>>(GetBlockSliceResponse::VT_DATA, None)}
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> GetBlockSliceResponseBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> GetBlockSliceResponseBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl<'a> GetUndoSliceRequest<'a> {
  ...
  pub fn file_num(&self) -> u32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u32>(GetUndoSliceRequest::VT_FILE_NUM, Some(0)).unwrap()}
  }
  #[inline]
  pub fn undo_pos(&self) -> u32 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u32>(GetUndoSliceRequest::VT_UNDO_POS, Some(0)).unwrap()}
  }
  #[inline]
  pub fn num_bytes(&self) -> u32 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u32>(GetUndoSliceRequest::VT_NUM_BYTES, Some(0)).unwrap()}
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> GetUndoSliceRequestBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> GetUndoSliceRequestBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl<'a> GetUndoSliceResponse<'a> {
  ...
  pub fn data(&self) -> Option<::flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, u8>>>(GetUndoSliceResponse::VT_DATA, None)}
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> GetUndoSliceResponseBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> GetUndoSliceResponseBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> GetMempoolRequestBuilder<'a, 'b, A> {
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> GetMempoolRequestBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl<'a> GetMempoolResponse<'a> {
  ...
  pub fn txs(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<MempoolTx<'a>>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<MempoolTx>>>>(GetMempoolResponse::VT_TXS, None)}
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> GetMempoolResponseBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> GetMempoolResponseBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl<'a> MiningTemplateTx<'a> {
  ...
  pub fn raw(&self) -> Option<::flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, u8>>>(MiningTemplateTx::VT_RAW, None)}
  }
  #[inline]
  pub fn txid(&self) -> Option<TxId<'a>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<TxId>>(MiningTemplateTx::VT_TXID, None)}
  }
  #[inline]
  pub fn fee(&self) -> i64 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(MiningTemplateTx::VT_FEE, Some(0)).unwrap()}
  }
  #[inline]
  pub fn sigops(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(MiningTemplateTx::VT_SIGOPS, Some(0)).unwrap()}
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> MiningTemplateTxBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_raw(&mut self, raw: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(MiningTemplateTx::VT_RAW, raw);
  }
  #[inline]
  pub fn add_txid(&mut self, txid: ::flatbuffers::WIPOffset<TxId<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<TxId>>(MiningTemplateTx::VT_TXID, txid);
  }
  #[inline]
  ...
  pub fn add_sigops(&mut self, sigops: i64) {
    self.fbb_.push_slot::<i64>(MiningTemplateTx::VT_SIGOPS, sigops, 0);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> MiningTemplateTxBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl<'a> GetMiningTemplateRequest<'a> {
  ...
  pub const VT_EXTRANONCE1_SIZE: ::flatbuffers::VOffsetT = 6;
  pub const VT_EXTRANONCE2_SIZE: ::flatbuffers::VOffsetT = 8;
  pub const VT_INCLUDE_TRANSACTIONS: ::flatbuffers::VOffsetT = 10;
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.coinbase_script { builder.add_coinbase_script(x); }
  ...
  pub fn coinbase_script(&self) -> Option<::flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, u8>>>(GetMiningTemplateRequest::VT_COINBASE_SCRIPT, None)}
  }
  #[inline]
  pub fn extranonce1_size(&self) -> u32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u32>(GetMiningTemplateRequest::VT_EXTRANONCE1_SIZE, Some(4)).unwrap()}
  }
  #[inline]
  pub fn extranonce2_size(&self) -> u32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u32>(GetMiningTemplateRequest::VT_EXTRANONCE2_SIZE, Some(4)).unwrap()}
  }
  #[inline]
  pub fn include_transactions(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(GetMiningTemplateRequest::VT_INCLUDE_TRANSACTIONS, Some(true)).unwrap()}
  }
}
...
impl ::flatbuffers::Verifiable for GetMiningTemplateRequest<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, u8>>>("coinbase_script", Self::VT_COINBASE_SCRIPT, false)?
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> GetMiningTemplateRequestBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_coinbase_script(&mut self, coinbase_script: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(GetMiningTemplateRequest::VT_COINBASE_SCRIPT, coinbase_script);
  }
  #[inline]
  pub fn add_extranonce1_size(&mut self, extranonce1_size: u32) {
    self.fbb_.push_slot::<u32>(GetMiningTemplateRequest::VT_EXTRANONCE1_SIZE, extranonce1_size, 4);
  }
  #[inline]
  pub fn add_extranonce2_size(&mut self, extranonce2_size: u32) {
    self.fbb_.push_slot::<u32>(GetMiningTemplateRequest::VT_EXTRANONCE2_SIZE, extranonce2_size, 4);
  }
  #[inline]
  pub fn add_include_transactions(&mut self, include_transactions: bool) {
    self.fbb_.push_slot::<bool>(GetMiningTemplateRequest::VT_INCLUDE_TRANSACTIONS, include_transactions, true);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> GetMiningTemplateRequestBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl<'a> GetMiningTemplateResponse<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.ntime_stratum { builder.add_ntime_stratum(x); }
    if let Some(x) = args.nbits_stratum { builder.add_nbits_stratum(x); }
    if let Some(x) = args.prev_hash_stratum { builder.add_prev_hash_stratum(x); }
    if let Some(x) = args.merkle_branches { builder.add_merkle_branches(x); }
    if let Some(x) = args.coinbase2 { builder.add_coinbase2(x); }
    if let Some(x) = args.coinbase1 { builder.add_coinbase1(x); }
    if let Some(x) = args.transactions { builder.add_transactions(x); }
    if let Some(x) = args.coinbase_tx { builder.add_coinbase_tx(x); }
    if let Some(x) = args.target { builder.add_target(x); }
    builder.add_bits(args.bits);
    builder.add_version(args.version);
    builder.add_height(args.height);
    if let Some(x) = args.previous_block_hash { builder.add_previous_block_hash(x); }
    if let Some(x) = args.header { builder.add_header(x); }
    if let Some(x) = args.block { builder.add_block(x); }
    builder.finish()
  }
  ...
  pub fn template_id(&self) -> u64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u64>(GetMiningTemplateResponse::VT_TEMPLATE_ID, Some(0)).unwrap()}
  }
  #[inline]
  pub fn block(&self) -> Option<::flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, u8>>>(GetMiningTemplateResponse::VT_BLOCK, None)}
  }
  #[inline]
  pub fn header(&self) -> Option<::flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, u8>>>(GetMiningTemplateResponse::VT_HEADER, None)}
  }
  #[inline]
  pub fn previous_block_hash(&self) -> Option<BlockHash<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<BlockHash>>(GetMiningTemplateResponse::VT_PREVIOUS_BLOCK_HASH, None)}
  }
  #[inline]
  pub fn height(&self) -> i32 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(GetMiningTemplateResponse::VT_HEIGHT, Some(0)).unwrap()}
  }
  #[inline]
  pub fn version(&self) -> u32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u32>(GetMiningTemplateResponse::VT_VERSION, Some(0)).unwrap()}
  }
  #[inline]
  pub fn bits(&self) -> u32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u32>(GetMiningTemplateResponse::VT_BITS, Some(0)).unwrap()}
  }
  #[inline]
  pub fn target(&self) -> Option<&'a Hash> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<Hash>(GetMiningTemplateResponse::VT_TARGET, None)}
  }
  #[inline]
  pub fn curtime(&self) -> u64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u64>(GetMiningTemplateResponse::VT_CURTIME, Some(0)).unwrap()}
  }
  #[inline]
  pub fn mintime(&self) -> u64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u64>(GetMiningTemplateResponse::VT_MINTIME, Some(0)).unwrap()}
  }
  #[inline]
  pub fn maxtime(&self) -> u64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u64>(GetMiningTemplateResponse::VT_MAXTIME, Some(0)).unwrap()}
  }
  #[inline]
  pub fn coinbase_value(&self) -> u64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u64>(GetMiningTemplateResponse::VT_COINBASE_VALUE, Some(0)).unwrap()}
  }
  #[inline]
  pub fn coinbase_tx(&self) -> Option<::flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, u8>>>(GetMiningTemplateResponse::VT_COINBASE_TX, None)}
  }
  #[inline]
  pub fn transactions(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<MiningTemplateTx<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<MiningTemplateTx>>>>(GetMiningTemplateResponse::VT_TRANSACTIONS, None)}
  }
  #[inline]
  pub fn coinbase1(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(GetMiningTemplateResponse::VT_COINBASE1, None)}
  }
  #[inline]
  pub fn coinbase2(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(GetMiningTemplateResponse::VT_COINBASE2, None)}
  }
  #[inline]
  pub fn merkle_branches(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<&'a str>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<&'a str>>>>(GetMiningTemplateResponse::VT_MERKLE_BRANCHES, None)}
  }
  #[inline]
  pub fn prev_hash_stratum(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(GetMiningTemplateResponse::VT_PREV_HASH_STRATUM, None)}
  }
  #[inline]
  pub fn nbits_stratum(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(GetMiningTemplateResponse::VT_NBITS_STRATUM, None)}
  }
  #[inline]
  pub fn ntime_stratum(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(GetMiningTemplateResponse::VT_NTIME_STRATUM, None)}
  }
}
...
impl ::flatbuffers::Verifiable for GetMiningTemplateResponse<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, u8>>>("block", Self::VT_BLOCK, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, u8>>>("header", Self::VT_HEADER, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<BlockHash>>("previous_block_hash", Self::VT_PREVIOUS_BLOCK_HASH, false)?
     .visit_field::<i32>("height", Self::VT_HEIGHT, false)?
     ...
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, u8>>>("coinbase_tx", Self::VT_COINBASE_TX, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<MiningTemplateTx>>>>("transactions", Self::VT_TRANSACTIONS, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("coinbase1", Self::VT_COINBASE1, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("coinbase2", Self::VT_COINBASE2, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<&'_ str>>>>("merkle_branches", Self::VT_MERKLE_BRANCHES, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("prev_hash_stratum", Self::VT_PREV_HASH_STRATUM, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("nbits_stratum", Self::VT_NBITS_STRATUM, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("ntime_stratum", Self::VT_NTIME_STRATUM, false)?
     .finish();
    Ok(())
  }
}
pub struct GetMiningTemplateResponseArgs<'a> {
    ...
    pub transactions: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<MiningTemplateTx<'a>>>>>,
    pub coinbase1: Option<::flatbuffers::WIPOffset<&'a str>>,
    pub coinbase2: Option<::flatbuffers::WIPOffset<&'a str>>,
    pub merkle_branches: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<&'a str>>>>,
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> GetMiningTemplateResponseBuilder<'a, 'b, A> {
  ...
  pub fn add_template_id(&mut self, template_id: u64) {
    self.fbb_.push_slot::<u64>(GetMiningTemplateResponse::VT_TEMPLATE_ID, template_id, 0);
  }
  #[inline]
  pub fn add_block(&mut self, block: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(GetMiningTemplateResponse::VT_BLOCK, block);
  }
  #[inline]
  pub fn add_header(&mut self, header: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(GetMiningTemplateResponse::VT_HEADER, header);
  }
  #[inline]
  pub fn add_previous_block_hash(&mut self, previous_block_hash: ::flatbuffers::WIPOffset<BlockHash<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<BlockHash>>(GetMiningTemplateResponse::VT_PREVIOUS_BLOCK_HASH, previous_block_hash);
  }
  #[inline]
  pub fn add_height(&mut self, height: i32) {
    self.fbb_.push_slot::<i32>(GetMiningTemplateResponse::VT_HEIGHT, height, 0);
  }
  #[inline]
  pub fn add_version(&mut self, version: u32) {
    self.fbb_.push_slot::<u32>(GetMiningTemplateResponse::VT_VERSION, version, 0);
  }
  #[inline]
  pub fn add_bits(&mut self, bits: u32) {
    self.fbb_.push_slot::<u32>(GetMiningTemplateResponse::VT_BITS, bits, 0);
  }
  #[inline]
  pub fn add_target(&mut self, target: &Hash) {
    self.fbb_.push_slot_always::<&Hash>(GetMiningTemplateResponse::VT_TARGET, target);
  }
  #[inline]
  pub fn add_curtime(&mut self, curtime: u64) {
    self.fbb_.push_slot::<u64>(GetMiningTemplateResponse::VT_CURTIME, curtime, 0);
  }
  #[inline]
  pub fn add_mintime(&mut self, mintime: u64) {
    self.fbb_.push_slot::<u64>(GetMiningTemplateResponse::VT_MINTIME, mintime, 0);
  }
  #[inline]
  pub fn add_maxtime(&mut self, maxtime: u64) {
    self.fbb_.push_slot::<u64>(GetMiningTemplateResponse::VT_MAXTIME, maxtime, 0);
  }
  #[inline]
  pub fn add_coinbase_value(&mut self, coinbase_value: u64) {
    self.fbb_.push_slot::<u64>(GetMiningTemplateResponse::VT_COINBASE_VALUE, coinbase_value, 0);
  }
  #[inline]
  pub fn add_coinbase_tx(&mut self, coinbase_tx: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(GetMiningTemplateResponse::VT_COINBASE_TX, coinbase_tx);
  }
  #[inline]
  pub fn add_transactions(&mut self, transactions: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<MiningTemplateTx<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(GetMiningTemplateResponse::VT_TRANSACTIONS, transactions);
  }
  #[inline]
  pub fn add_coinbase1(&mut self, coinbase1: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(GetMiningTemplateResponse::VT_COINBASE1, coinbase1);
  }
  #[inline]
  pub fn add_coinbase2(&mut self, coinbase2: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(GetMiningTemplateResponse::VT_COINBASE2, coinbase2);
  }
  #[inline]
  pub fn add_merkle_branches(&mut self, merkle_branches: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(GetMiningTemplateResponse::VT_MERKLE_BRANCHES, merkle_branches);
  }
  #[inline]
  pub fn add_prev_hash_stratum(&mut self, prev_hash_stratum: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(GetMiningTemplateResponse::VT_PREV_HASH_STRATUM, prev_hash_stratum);
  }
  #[inline]
  pub fn add_nbits_stratum(&mut self, nbits_stratum: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(GetMiningTemplateResponse::VT_NBITS_STRATUM, nbits_stratum);
  }
  #[inline]
  pub fn add_ntime_stratum(&mut self, ntime_stratum: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(GetMiningTemplateResponse::VT_NTIME_STRATUM, ntime_stratum);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> GetMiningTemplateResponseBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl<'a> SubmitMinedBlockRequest<'a> {
  ...
  pub fn block(&self) -> Option<::flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, u8>>>(SubmitMinedBlockRequest::VT_BLOCK, None)}
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> SubmitMinedBlockRequestBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_block(&mut self, block: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(SubmitMinedBlockRequest::VT_BLOCK, block);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> SubmitMinedBlockRequestBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl<'a> SubmitMinedBlockResponse<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.block_hash { builder.add_block_hash(x); }
    if let Some(x) = args.reject_reason { builder.add_reject_reason(x); }
  ...
  pub fn result(&self) -> MiningSubmitResult {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<MiningSubmitResult>(SubmitMinedBlockResponse::VT_RESULT, Some(MiningSubmitResult::ACCEPTED)).unwrap()}
  }
  #[inline]
  pub fn accepted(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(SubmitMinedBlockResponse::VT_ACCEPTED, Some(false)).unwrap()}
  }
  #[inline]
  pub fn reject_reason(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(SubmitMinedBlockResponse::VT_REJECT_REASON, None)}
  }
  #[inline]
  pub fn block_hash(&self) -> Option<BlockHash<'a>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<BlockHash>>(SubmitMinedBlockResponse::VT_BLOCK_HASH, None)}
  }
}
...
impl ::flatbuffers::Verifiable for SubmitMinedBlockResponse<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("reject_reason", Self::VT_REJECT_REASON, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<BlockHash>>("block_hash", Self::VT_BLOCK_HASH, false)?
     .finish();
    Ok(())
  }
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> SubmitMinedBlockResponseBuilder<'a, 'b, A> {
  ...
  pub fn add_result(&mut self, result: MiningSubmitResult) {
    self.fbb_.push_slot::<MiningSubmitResult>(SubmitMinedBlockResponse::VT_RESULT, result, MiningSubmitResult::ACCEPTED);
  }
  #[inline]
  pub fn add_accepted(&mut self, accepted: bool) {
    self.fbb_.push_slot::<bool>(SubmitMinedBlockResponse::VT_ACCEPTED, accepted, false);
  }
  #[inline]
  pub fn add_reject_reason(&mut self, reject_reason: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(SubmitMinedBlockResponse::VT_REJECT_REASON, reject_reason);
  }
  #[inline]
  pub fn add_block_hash(&mut self, block_hash: ::flatbuffers::WIPOffset<BlockHash<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<BlockHash>>(SubmitMinedBlockResponse::VT_BLOCK_HASH, block_hash);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> SubmitMinedBlockResponseBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl<'a> ValidateMinedBlockProposalRequest<'a> {
  ...
  pub fn block(&self) -> Option<::flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, u8>>>(ValidateMinedBlockProposalRequest::VT_BLOCK, None)}
  }
}
...
pub struct ValidateMinedBlockProposalRequestBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> ValidateMinedBlockProposalRequestBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_block(&mut self, block: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(ValidateMinedBlockProposalRequest::VT_BLOCK, block);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> ValidateMinedBlockProposalRequestBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl<'a> ValidateMinedBlockProposalResponse<'a> {
  ...
  pub fn result(&self) -> MiningSubmitResult {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<MiningSubmitResult>(ValidateMinedBlockProposalResponse::VT_RESULT, Some(MiningSubmitResult::ACCEPTED)).unwrap()}
  }
  #[inline]
  pub fn valid(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(ValidateMinedBlockProposalResponse::VT_VALID, Some(false)).unwrap()}
  }
  #[inline]
  pub fn reject_reason(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(ValidateMinedBlockProposalResponse::VT_REJECT_REASON, None)}
  }
}
...
pub struct ValidateMinedBlockProposalResponseBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> ValidateMinedBlockProposalResponseBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_result(&mut self, result: MiningSubmitResult) {
    self.fbb_.push_slot::<MiningSubmitResult>(ValidateMinedBlockProposalResponse::VT_RESULT, result, MiningSubmitResult::ACCEPTED);
  }
  #[inline]
  pub fn add_valid(&mut self, valid: bool) {
    self.fbb_.push_slot::<bool>(ValidateMinedBlockProposalResponse::VT_VALID, valid, false);
  }
  #[inline]
  pub fn add_reject_reason(&mut self, reject_reason: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(ValidateMinedBlockProposalResponse::VT_REJECT_REASON, reject_reason);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> ValidateMinedBlockProposalResponseBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
pub enum SendRawTransactionRequestOffset {}
#[derive(Copy, Clone, PartialEq)]
...
impl<'a> ::flatbuffers::Follow<'a> for SendRawTransactionRequest<'a> {
  type Inner = SendRawTransactionRequest<'a>;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    Self { _tab: unsafe { ::flatbuffers::Table::new(buf, loc) } }
  }
...
impl<'a> SendRawTransactionRequest<'a> {
  pub const VT_RAW_TX: ::flatbuffers::VOffsetT = 4;
  pub const VT_MAX_FEE_RATE: ::flatbuffers::VOffsetT = 6;
  pub const VT_RELAY: ::flatbuffers::VOffsetT = 8;
  pub const VT_WAIT_CALLBACK: ::flatbuffers::VOffsetT = 10;

  #[inline]
  pub unsafe fn init_from_table(table: ::flatbuffers::Table<'a>) -> Self {
    SendRawTransactionRequest { _tab: table }
  }
  #[allow(unused_mut)]
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    _fbb: &'mut_bldr mut ::flatbuffers::FlatBufferBuilder<'bldr, A>,
    args: &'args SendRawTransactionRequestArgs<'args>
  ) -> ::flatbuffers::WIPOffset<SendRawTransactionRequest<'bldr>> {
    let mut builder = SendRawTransactionRequestBuilder::new(_fbb);
    builder.add_max_fee_rate(args.max_fee_rate);
    if let Some(x) = args.raw_tx { builder.add_raw_tx(x); }
    builder.add_wait_callback(args.wait_callback);
    builder.add_relay(args.relay);
    builder.finish()
  }


  #[inline]
  pub fn raw_tx(&self) -> Option<::flatbuffers::Vector<'a, u8>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, u8>>>(SendRawTransactionRequest::VT_RAW_TX, None)}
  }
  #[inline]
  pub fn max_fee_rate(&self) -> u64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u64>(SendRawTransactionRequest::VT_MAX_FEE_RATE, Some(0)).unwrap()}
  }
  #[inline]
  pub fn relay(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(SendRawTransactionRequest::VT_RELAY, Some(true)).unwrap()}
  }
  #[inline]
  pub fn wait_callback(&self) -> bool {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(SendRawTransactionRequest::VT_WAIT_CALLBACK, Some(true)).unwrap()}
  }
}

impl ::flatbuffers::Verifiable for SendRawTransactionRequest<'_> {
  #[inline]
  fn run_verifier(
    v: &mut ::flatbuffers::Verifier, pos: usize
  ) -> Result<(), ::flatbuffers::InvalidFlatbuffer> {
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, u8>>>("raw_tx", Self::VT_RAW_TX, false)?
     .visit_field::<u64>("max_fee_rate", Self::VT_MAX_FEE_RATE, false)?
     .visit_field::<bool>("relay", Self::VT_RELAY, false)?
     .visit_field::<bool>("wait_callback", Self::VT_WAIT_CALLBACK, false)?
     .finish();
    Ok(())
  }
}
pub struct SendRawTransactionRequestArgs<'a> {
    pub raw_tx: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, u8>>>,
    pub max_fee_rate: u64,
    pub relay: bool,
    pub wait_callback: bool,
}
impl<'a> Default for SendRawTransactionRequestArgs<'a> {
  #[inline]
  fn default() -> Self {
...
pub struct SendRawTransactionRequestBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> SendRawTransactionRequestBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_raw_tx(&mut self, raw_tx: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(SendRawTransactionRequest::VT_RAW_TX, raw_tx);
  }
  #[inline]
  pub fn add_max_fee_rate(&mut self, max_fee_rate: u64) {
    self.fbb_.push_slot::<u64>(SendRawTransactionRequest::VT_MAX_FEE_RATE, max_fee_rate, 0);
  }
  #[inline]
  pub fn add_relay(&mut self, relay: bool) {
    self.fbb_.push_slot::<bool>(SendRawTransactionRequest::VT_RELAY, relay, true);
  }
  #[inline]
  pub fn add_wait_callback(&mut self, wait_callback: bool) {
    self.fbb_.push_slot::<bool>(SendRawTransactionRequest::VT_WAIT_CALLBACK, wait_callback, true);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> SendRawTransactionRequestBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  #[inline]
  pub fn finish(self) -> ::flatbuffers::WIPOffset<SendRawTransactionRequest<'a>> {
    let o = self.fbb_.end_table(self.start_);
    ::flatbuffers::WIPOffset::new(o.value())
  }
}

impl ::core::fmt::Debug for SendRawTransactionRequest<'_> {
  fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
    let mut ds = f.debug_struct("SendRawTransactionRequest");
      ds.field("raw_tx", &self.raw_tx());
      ds.field("max_fee_rate", &self.max_fee_rate());
      ds.field("relay", &self.relay());
      ds.field("wait_callback", &self.wait_callback());
      ds.finish()
  }
}
pub enum SendRawTransactionResponseOffset {}
#[derive(Copy, Clone, PartialEq)]

pub struct SendRawTransactionResponse<'a> {
  pub _tab: ::flatbuffers::Table<'a>,
}

impl<'a> ::flatbuffers::Follow<'a> for SendRawTransactionResponse<'a> {
  type Inner = SendRawTransactionResponse<'a>;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    Self { _tab: unsafe { ::flatbuffers::Table::new(buf, loc) } }
  }
...
impl<'a> SendRawTransactionResponse<'a> {
  pub const VT_RESULT: ::flatbuffers::VOffsetT = 4;
  pub const VT_ACCEPTED: ::flatbuffers::VOffsetT = 6;
  pub const VT_TXID: ::flatbuffers::VOffsetT = 8;
  pub const VT_REJECT_REASON: ::flatbuffers::VOffsetT = 10;

  #[inline]
  pub unsafe fn init_from_table(table: ::flatbuffers::Table<'a>) -> Self {
    SendRawTransactionResponse { _tab: table }
  }
  #[allow(unused_mut)]
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    _fbb: &'mut_bldr mut ::flatbuffers::FlatBufferBuilder<'bldr, A>,
    args: &'args SendRawTransactionResponseArgs<'args>
  ) -> ::flatbuffers::WIPOffset<SendRawTransactionResponse<'bldr>> {
    let mut builder = SendRawTransactionResponseBuilder::new(_fbb);
    if let Some(x) = args.reject_reason { builder.add_reject_reason(x); }
    if let Some(x) = args.txid { builder.add_txid(x); }
    builder.add_result(args.result);
    builder.add_accepted(args.accepted);
  ...
  #[inline]
  pub fn result(&self) -> SendRawTransactionResult {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<SendRawTransactionResult>(SendRawTransactionResponse::VT_RESULT, Some(SendRawTransactionResult::ACCEPTED)).unwrap()}
  }
  #[inline]
  pub fn accepted(&self) -> bool {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(SendRawTransactionResponse::VT_ACCEPTED, Some(false)).unwrap()}
  }
  #[inline]
  pub fn txid(&self) -> Option<TxId<'a>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<TxId>>(SendRawTransactionResponse::VT_TXID, None)}
  }
  #[inline]
  pub fn reject_reason(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(SendRawTransactionResponse::VT_REJECT_REASON, None)}
  }
}

impl ::flatbuffers::Verifiable for SendRawTransactionResponse<'_> {
  #[inline]
  fn run_verifier(
    v: &mut ::flatbuffers::Verifier, pos: usize
  ) -> Result<(), ::flatbuffers::InvalidFlatbuffer> {
    v.visit_table(pos)?
     .visit_field::<SendRawTransactionResult>("result", Self::VT_RESULT, false)?
     .visit_field::<bool>("accepted", Self::VT_ACCEPTED, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<TxId>>("txid", Self::VT_TXID, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("reject_reason", Self::VT_REJECT_REASON, false)?
     .finish();
...
pub struct SendRawTransactionResponseArgs<'a> {
    pub result: SendRawTransactionResult,
    pub accepted: bool,
    pub txid: Option<::flatbuffers::WIPOffset<TxId<'a>>>,
    pub reject_reason: Option<::flatbuffers::WIPOffset<&'a str>>,
}
impl<'a> Default for SendRawTransactionResponseArgs<'a> {
  #[inline]
  fn default() -> Self {
    SendRawTransactionResponseArgs {
      result: SendRawTransactionResult::ACCEPTED,
      accepted: false,
      txid: None,
      reject_reason: None,
    }
...
pub struct SendRawTransactionResponseBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> SendRawTransactionResponseBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_result(&mut self, result: SendRawTransactionResult) {
    self.fbb_.push_slot::<SendRawTransactionResult>(SendRawTransactionResponse::VT_RESULT, result, SendRawTransactionResult::ACCEPTED);
  }
  #[inline]
  pub fn add_accepted(&mut self, accepted: bool) {
    self.fbb_.push_slot::<bool>(SendRawTransactionResponse::VT_ACCEPTED, accepted, false);
  }
  #[inline]
  pub fn add_txid(&mut self, txid: ::flatbuffers::WIPOffset<TxId<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<TxId>>(SendRawTransactionResponse::VT_TXID, txid);
  }
  #[inline]
  pub fn add_reject_reason(&mut self, reject_reason: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(SendRawTransactionResponse::VT_REJECT_REASON, reject_reason);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> SendRawTransactionResponseBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    SendRawTransactionResponseBuilder {
      fbb_: _fbb,
      start_: start,
    }
  }
  #[inline]
  pub fn finish(self) -> ::flatbuffers::WIPOffset<SendRawTransactionResponse<'a>> {
    let o = self.fbb_.end_table(self.start_);
    ::flatbuffers::WIPOffset::new(o.value())
  }
}

impl ::core::fmt::Debug for SendRawTransactionResponse<'_> {
  fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
    let mut ds = f.debug_struct("SendRawTransactionResponse");
      ds.field("result", &self.result());
      ds.field("accepted", &self.accepted());
      ds.field("txid", &self.txid());
      ds.field("reject_reason", &self.reject_reason());
