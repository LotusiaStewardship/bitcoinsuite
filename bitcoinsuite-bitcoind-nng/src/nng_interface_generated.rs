...
impl<'a> GetMiningTemplateRequest<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.coinbase_identity { builder.add_coinbase_identity(x); }
  ...
  pub fn coinbase_identity(&self) -> Option<::flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, u8>>>(GetMiningTemplateRequest::VT_COINBASE_IDENTITY, None)}
  }
  #[inline]
...
impl ::flatbuffers::Verifiable for GetMiningTemplateRequest<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, u8>>>("coinbase_identity", Self::VT_COINBASE_IDENTITY, false)?
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> GetMiningTemplateRequestBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn add_coinbase_identity(&mut self, coinbase_identity: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(GetMiningTemplateRequest::VT_COINBASE_IDENTITY, coinbase_identity);
  }
  #[inline]
